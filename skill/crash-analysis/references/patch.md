...
Use the template at
`crash-analysis/templates/patch-email-template.md` as the
...
| `Assisted-by: <agent>:<model> crash-analysis.` | **Mandatory.** Replace with the actual agent name and model version. |
